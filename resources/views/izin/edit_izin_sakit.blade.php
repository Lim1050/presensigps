...
<div class="appHeader gradasired text-light">
    ...
    <div class="pageTitle">Perubahan Izin Sakit </div>
    <div class="right"></div>
</div>
{{-- App Header --}}
@endsection
...
<div class="row" style="margin-top: 70px;">
    <div class="col">
        <form action="{{ route('izin.sakit.update', $data_izin->kode_izin) }}" method="POST" enctype="multipart/form-data" style="min-height: 1000px" id="formIzinSakit">
            @csrf
            <div class="form-group">
                <input type="text" class="form-control datepicker" name="tanggal_izin_dari" id="tanggal_izin_dari" placeholder="Dari" value="{{ $data_izin->tanggal_izin_dari }}">
            </div>

            <div class="form-group">
                <input type="text" class="form-control datepicker" name="tanggal_izin_sampai" id="tanggal_izin_sampai" placeholder="Sampai" value="{{ $data_izin->tanggal_izin_sampai }}">
            </div>
            ...
            <div class="form-group">
                <input type="text" class="form-control" name="keterangan" id="keterangan" placeholder="Keterangan" value="{{ $data_izin->keterangan }}">
            </div>

            @if ($data_izin->surat_sakit != null)
                <div class="row">
                    <div class="col-12">
                        @php
                            $surat_sakit = Storage::url('/uploads/surat_sakit/' . $data_izin->surat_sakit);
                        @endphp
                        <img src="{{ url($surat_sakit) }}" alt="" width="100px" height="auto">
                    </div>
                </div>
            @endif
            ...
            <div class="form-group">
                <div class="input-wrapper">
                    <button type="submit" class="btn btn-danger btn-block">
                        Perbarui <ion-icon name="refresh-outline"></ion-icon>
                    </button>
                </div>
            </div>
        </form>
