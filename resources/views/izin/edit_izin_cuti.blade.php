...
<div class="appHeader gradasired text-light">
    ...
    <div class="pageTitle">Perubahan Izin Cuti </div>
    <div class="right"></div>
</div>
{{-- App Header --}}
@endsection
...
<div class="row" style="margin-top: 70px;">
    <div class="col">
        <form action="{{ route('izin.cuti.update', $data_izin->kode_izin) }}" method="POST" enctype="multipart/form-data" style="min-height: 1000px" id="formIzinCuti">
            @csrf
            ...
            <div class="form-group">
                <select name="kode_cuti" id="kode_cuti" class="form-control selectmaterialize">
                    ...
                    <option {{ $data_izin->kode_cuti == $cuti->kode_cuti ? 'selected' : '' }} value="{{ $cuti->kode_cuti }}">{{ $cuti->nama_cuti }}</option>
                    @endforeach
                </select>
            </div>
