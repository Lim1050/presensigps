...
<div class="appHeader gradasired text-light">
    ...
    <div class="pageTitle">Perubahan Izin Absen </div>
    <div class="right"></div>
</div>
{{-- App Header --}}
@endsection
...
<div class="row" style="margin-top: 70px;">
    <div class="col">
        <form action="{{ route('izin.absen.update', $data_izin->kode_izin) }}" method="POST" enctype="multipart/form-data" style="min-height: 1000px" id="formIzinAbsen">
            @csrf
