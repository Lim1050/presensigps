<ul class="navbar-nav bg-danger sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        <a class="nav-link collapsed {{ request()->is(['admin/konfigurasi/jenis/gaji*','admin/konfigurasi/jam/kerja*', 'admin/konfigurasi/jam-kerja-dept*', 'admin/konfigurasi/user*', 'admin/konfigurasi/role*', 'admin/konfigurasi/permission*', 'admin/konfigurasi/add-role-in-permission*']) ? 'active' : '' }}" href="#" data-toggle="collapse" data-target="#collapseFour"
            aria-expanded="{{ request()->is(['admin/konfigurasi/jenis/gaji*','admin/konfigurasi/jam/kerja*', 'admin/konfigurasi/jam-kerja-dept*', 'admin/konfigurasi/user*', 'admin/konfigurasi/role*', 'admin/konfigurasi/permission*', 'admin/konfigurasi/add-role-in-permission*']) ? 'true' : 'false' }}" aria-controls="collapseFour">
