...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Konfigurasi Jam Kerja Lokasi Penugasan</h1>
</div>
    ...
    <div class="card-body">
        <div class="row mb-4">
            <div class="col-12">
                ...
                @endif
                <a href="{{ route('admin.konfigurasi.jam-kerja.lokasi-penugasan.create')}}" class="btn btn-primary"><i class="bi bi-plus-lg"></i> Tambah Data Jam Kerja</a>
            </div>
        </div>
            ...
            <div class="col-12">
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-striped" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            @foreach ($jamKerjaLokasiPenugasan as $item)
                            <tr>
                                <td class="text-center">{{ $loop->iteration }}</td>
                                <td class="text-center">{{ $item->kode_jk_lp_c  }}</td>
                                <td class="text-center">{{ $item->lokasiPenugasan->nama_lokasi_penugasan }}</td>
                                <td class="text-center">{{ $item->kantorCabang->nama_cabang }}</td>
                                <td class="text-center">{{ $item->jam_kerja->nama_jam_kerja }}</td>
                                <td class="text-center">{{ $item->hari }}</td>
                                <td class="text-center">{{ $item->jam_kerja->awal_jam_masuk }}</td>
                                <td class="text-center">{{ $item->jam_kerja->jam_masuk }}</td>
                                <td class="text-center">{{ $item->jam_kerja->akhir_jam_masuk }}</td>
                                <td class="text-center">{{ $item->jam_kerja->jam_pulang }}</td>
                                ...
                                <td class="text-center">
                                    <div class="btn-group ">
                                        <a href="#" class="btn btn-warning" data-toggle="modal" data-target="#modalEditJamKerja"
                                            data-kode_jk_lp_c="{{ $item->kode_jk_lp_c }}"
                                        ...
                                        <a href="{{ route('admin.konfigurasi.jam.kerja.delete', $item->kode_jk_lp_c) }}" class="btn btn-danger delete-confirm"><i class="bi bi-trash3"></i> Delete</a>
                                    </div>
                                </td>
                            </tr>
                            @endforeach
                ...
                <form action="{{ route('admin.konfigurasi.jam.kerja.store') }}" method="POST" id="formJamKerja" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <div class="icon-placeholder">
                            ...
                            <input type="text" class="form-control" id="kode_jk_lp_c" name="kode_jk_lp_c" placeholder=" Kode Jam Kerja">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="icon-placeholder">
