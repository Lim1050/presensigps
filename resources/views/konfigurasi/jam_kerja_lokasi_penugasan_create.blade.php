...
<div class="card shadow mb-4">
    <div class="card-body">
        <a href="{{ route('admin.konfigurasi.jam-kerja.lokasi-penugasan')}}" class="btn btn-danger mb-2"><i class="bi bi-backspace"></i> Kembali</a>
        <form action="{{ route('admin.konfigurasi.jam-kerja.lokasi-penugasan.store') }}" method="POST">
            @csrf
            <div class="row">
                <div class="col-12">
                    <div class="row">
                            ...
                            <div class="form-group">
                                <select name="kode_lokasi_penugasan" id="kode_lokasi_penugasan" class="form-control" required>
                                    ...
                                    @foreach ($lokasi_penugasan as $item)
                                        <option value="{{ $item->kode_lokasi_penugasan }}">{{ strtoupper($item->nama_lokasi_penugasan) }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
