...
CREATE TABLE `lembur` (
  `id` bigint UNSIGNED NOT NULL,
  `kode_lembur` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nik` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `jenis_lembur` enum('penebalan','reguler','khusus') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'reguler',
  `jam_masuk_asli` time DEFAULT NULL,
  `jam_pulang_asli` time DEFAULT NULL,
  `total_absen` int NOT NULL DEFAULT '1',
...
INSERT INTO `lembur` (`id`, `kode_lembur`, `nik`, `tanggal_presensi`, `waktu_mulai`, `waktu_selesai`, `durasi_menit`, `lintas_hari`, `lembur_libur`, `catatan_lembur`, `status`, `jenis_lembur`, `jam_masuk_asli`, `jam_pulang_asli`, `total_absen`, `alasan_penolakan`, `created_at`, `updated_at`) VALUES
(2, NULL, '123123123', '2024-10-30', '17:00:00', '00:00:00', 420, 1, 1, 'Test Catatan Lembur', 'disetujui', 'reguler', NULL, NULL, 1, NULL, '2024-10-30 08:07:28', '2024-10-31 10:14:15'),
(5, NULL, '444444444', '2024-10-31', '14:44:00', '23:44:00', 540, 0, 1, 'Test Catatan Lembur', 'pending', 'reguler', NULL, NULL, 1, NULL, '2024-10-31 06:44:53', '2024-10-31 07:09:58'),
(6, NULL, '123456789', '2024-11-01', '00:00:00', '14:00:00', 840, 0, 1, 'Test Catatan Lembur', 'pending', 'reguler', NULL, NULL, 1, NULL, '2024-10-31 07:07:24', '2024-10-31 07:07:24'),
(7, NULL, '123123123', '2024-11-02', '16:00:00', '16:30:00', 120, 0, 1, 'asdwqeasff', 'disetujui', 'reguler', NULL, NULL, 1, NULL, '2024-10-31 09:20:27', '2024-11-02 06:53:02'),
(8, NULL, '123123123', '2024-11-01', '16:10:00', '16:18:00', 60, 0, 1, 'Test Lemburan', 'disetujui', 'reguler', NULL, NULL, 1, NULL, '2024-11-01 07:47:12', '2024-11-01 08:06:38'),
(12, NULL, '123123123', '2024-11-19', '12:50:00', '13:50:00', 60, 0, 1, 'Catatan Lembur', 'pending', 'reguler', NULL, NULL, 1, NULL, '2024-11-19 05:50:45', '2024-11-19 05:50:45'),
(13, NULL, '222222222', '2024-11-25', '14:13:00', '16:13:00', 120, 0, 1, 'Catatan Lembur', 'pending', 'reguler', NULL, NULL, 1, NULL, '2024-11-25 07:13:13', '2024-11-25 07:13:13'),
(15, NULL, '123123123', '2024-12-12', '21:30:00', '22:30:00', 60, 0, 1, 'Catatan Lembur', 'disetujui', 'reguler', NULL, NULL, 1, NULL, '2024-12-12 06:33:36', '2024-12-12 07:12:22'),
(16, NULL, '123123123', '2024-12-13', '00:00:00', '01:00:00', 60, 0, 0, 'Catatan Lembur', 'ditolak', 'reguler', NULL, NULL, 1, 'ge', '2024-12-12 06:44:32', '2024-12-12 06:48:58');
...
CREATE TABLE `penggajian` (
  ...
  `kehadiran_murni` int NOT NULL DEFAULT '0',
  `jumlah_isc` int NOT NULL DEFAULT '0',
...
CREATE TABLE `presensi` (
  ...
  `kode_lembur` bigint UNSIGNED DEFAULT NULL,
  `jenis_absen_lembur` enum('single','double') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
